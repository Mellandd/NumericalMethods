...
public class ParabolicThrowWithFriction implements InitialValueProblem {
    ...
    public static void main(String[] args) {
        ...
        double zeroIAt = LinealInterpolationMethod.findZero(interpolator, previousPoint.getTime(), 2, 3);
        ...
        double yZero2 = interpolator.getState(zeroIAt, 2);
        System.out.println("My method:");
        System.out.println("Zero at t="+zeroIAt+", y = "+yZero2);
